  ...
  return (
    <div className="hero-bg relative">
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        <p className="mb-4">
          Ready to wathc? Enter your email to create or restart your
          memebership.
        </p>
        <form
        ...
        >
          ...
          />
          <button className="bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-2 md:py-2 rounded flex justify-center items-center">
            Get Started
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              Sream unlimited movies and TV shows on your phone, tablet, laptop,
              and TV.
            </p>
          </div>
